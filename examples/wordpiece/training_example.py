...
本示例展示了如何使用文本数据训练一个新的WordPiece分词器。
...
def generate_sample_text():
    ...
    english_sentences = [
        ...
        "WordPiece algorithm is a subword-based tokenization method.",
    ...
    # 添加一些包含复合词的句子，展示WordPiece的优势
    compound_sentences = [
        "The preprocessing step is crucial for tokenization.",
        "Unhappiness is a complex emotional state.",
        "The unbelievable story was widely shared.",
        "Tokenization is a fundamental preprocessing step.",
        "The unbelievable performance of the model surprised everyone."
    ]
    
    # 混合所有句子，并添加一些随机变化
    all_sentences = chinese_sentences + english_sentences + compound_sentences
...
def main():
    ...
    try:
        ...
        # 测试训练后的分词器
        print("\n4. 测试训练后的分词器...")
        test_text = "这是一个测试WordPiece分词器的句子。This is a test sentence."
        ...
        # 保存训练好的分词器
        model_file = "wordpiece_tokenizer.json"
        ...
        # 加载保存的分词器
        print("\n8. 加载保存的分词器...")
        loaded_tokenizer = zero_tokenizer.wordpiece()
