#!/usr/bin/env python3
"""
示例：使用dict目录下的词表初始化Unigram分词器

这个示例展示了如何使用dict目录下的词表文件来初始化Unigram分词器。
"""
...
def main():
    ...
    # 创建Unigram分词器
    try:
        tokenizer = zero_tokenizer.UnigramTokenizer()
        print("✓ Unigram分词器创建成功")
    except Exception as e:
        print(f"✗ Unigram分词器创建失败: {e}")
        return 1
